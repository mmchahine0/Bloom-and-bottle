import type { PerfumeResponse, PerfumeFilters, Perfume } from "./WomenP.types"
import { apiClient } from "@/api/base"
import { ENDPOINTS } from "@/api/endpoints"

export const getWomenPerfumes = async (filters?: PerfumeFilters): Promise<PerfumeResponse> => {
  ...
  const endpoint = params.toString()
    ? `${ENDPOINTS.Products.Perfume.GetWomen}?${params.toString()}`
    : ENDPOINTS.Products.Perfume.GetWomen
